...
instance_create_depth(room_width/2, room_height/2, depth-1, oButtonMenu)
var spacing = oButtonMenu.height * 1.25
instance_create_depth(room_width/2, room_height/2 + spacing*1, depth-1, oButtonQuit)